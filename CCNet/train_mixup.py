...
model_file = "model_92_sgd_mixup300_normal20.pth"
...
if is_train is True:
        ...
        for i, (images, labels) in enumerate(train_loader):
            if is_mixup:
                inputs, targets_a, targets_b, lam = mixup_data(
                    images.to(device), labels.to(device), alpha=1.0
                )
    ...
    # Save the Model
    torch.save(
        model.state_dict(), "./save_weights/last_model_92_sgd_mixup300_normal20.pth"
    )
